...
func main() {
	...
	// Certificate watchers for webhook and metrics
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8241b32c.example.com",
	})
	if err != nil {
	...
	// Register the CanaryRollout controller
	if err := (&controllers.CanaryRolloutReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "CanaryRollout")
		os.Exit(1)
	}
